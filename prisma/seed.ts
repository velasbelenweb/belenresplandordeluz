...
const productos = [
  ...
  },
  {
    ...
    destacado: true,
    variantes: [
      { nombre: "Blanco", precio: 1100 },
      { nombre: "Azul Marino", precio: 1100 },
      { nombre: "Celeste", precio: 1100 },
      { nombre: "Amarillo", precio: 1100 },
      { nombre: "Verde", precio: 1100 },
      { nombre: "Rojo", precio: 1100 },
      { nombre: "Naranja", precio: 1100 },
      { nombre: "Rosado", precio: 1100 },
      { nombre: "Morado", precio: 1100 },
      { nombre: "Negro", precio: 1100 },
    ],
  },
  {
